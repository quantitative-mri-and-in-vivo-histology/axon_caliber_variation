...
Figures are generated by the correspondingly named scripts in `scripts/figures/` —
e.g. `plot_fig3_2d_vs_3d.py` produces Figure 3. Figure 2 is split across two scripts,
`plot_fig2ab_radius_profiles.py` (panels a–b) and `plot_fig2ce_variation_stats.py`
(panels c–e).
